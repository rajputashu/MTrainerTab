...
package com.sisindia.ai.mtrainer.android.features.barcode.camera
...
import com.sisindia.ai.mtrainer.android.features.barcode.CameraInputInfo
import com.sisindia.ai.mtrainer.android.features.barcode.InputInfo
import com.sisindia.ai.mtrainer.android.features.barcode.ScopedExecutor
...
abstract class FrameProcessorBase<T> : FrameProcessor {
    ...
    private fun processLatestFrame(graphicOverlay: GraphicOverlay) {
        ...
        detectInImage(image)
            ...
            .addOnFailureListener() { e -> OnFailureListener { this@FrameProcessorBase.onFailure(it) } }
    }
