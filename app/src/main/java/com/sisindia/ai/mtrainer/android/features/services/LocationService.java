package com.sisindia.ai.mtrainer.android.features.services;
...
import com.sisindia.ai.mtrainer.android.base.MTrainerBaseService;
...
public class LocationService extends MTrainerBaseService {
    ...
    private void createLocationCallback() {
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.v("Location Update : ", " Lat : " + lat + " LONG : " + longitude);
                Prefs.putDouble(PrefsConstants.LAT,lat);
                Prefs.putDouble(PrefsConstants.LONGI,longitude);
            }
        };
    }
