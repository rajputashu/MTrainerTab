...
public class SubModules extends BaseApiResponse {
    @SerializedName("Data")
    public List<MySubModuleslist> mySubModuleslistList;

    public SubModules() {

    }
    @Parcel
    @Entity(tableName = "sub_modules_table")
    public static class MySubModuleslist implements Serializable {
        @NonNull
