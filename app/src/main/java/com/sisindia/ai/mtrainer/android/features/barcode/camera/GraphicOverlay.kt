...
import com.sisindia.ai.mtrainer.android.features.barcode.Utils
import java.util.ArrayList

/**
 * A view which renders a series of spi_dialog graphics to be overlaid on top of an associated preview
...
class GraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    /**
     * Base class for a spi_dialog graphics object to be rendered within the graphic overlay. Subclass
